...
wandb.init(project="PerceptNet_INRF",
           job_type="training",
           mode="online",
           name="PerceptAchrom_TrainLast_NoPoolCS",
           config=config)
...
dst_train = TID2008("/media/databases/IQA/TID/TID2008/", exclude_imgs=[25]).dataset
dst_test = TID2013("/media/databases/IQA/TID/TID2013/", exclude_imgs=[25]).dataset
